...
| `bin/group create\|list\|show\|update\|add\|remove\|export ...`                                                                           | Create and maintain review groups in `data/<owner>/<repo>/groups/`; see [docs/groups.md](docs/groups.md#script-workflow).                                                                                                                                                                               |
